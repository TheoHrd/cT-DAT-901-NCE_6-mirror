...
topic_in_binance_coin = NewTopic(
    name=config['kafka']['TopicIn_BinanceCoin'],
    num_partitions=int(config['kafka']['TopicInPartitions_BinanceCoin']),
    replication_factor=int(config['kafka']['TopicInReplication_BinanceCoin'])
)
topic_out_binance_coin = NewTopic(
    name=config['kafka']['TopicOut_BinanceCoin'],
    num_partitions=int(config['kafka']['TopicOutPartitions_BinanceCoin']),
    replication_factor=int(config['kafka']['TopicOutReplication_BinanceCoin'])
)
...
new_topics = [topic_in_binance_coin, topic_out_binance_coin, topic_in_binance_Klines, topic_out_binance_Klines, topic_in_rssfeed, topic_out_rssfeed, topic_in_trends, topic_out_trends]
